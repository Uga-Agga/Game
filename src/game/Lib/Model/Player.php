...
class Player {
  ...
  public static function getPlayer($playerID, $complete=false) {
    // get player out of the database
    $sql = \Lib\Database::$db->prepare("SELECT * FROM " . PLAYER_TABLE . " WHERE playerID = :playerID");
  ...
  public static function getHistory($playerID) {
    global $db;
   ...
   */
  public function getTimeCorrection() {
