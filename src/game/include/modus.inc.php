...
$require_files[CAVE_DETAIL]                 = array('cave.html.php', 'formula_parser.inc.php', 'tribes.inc.php', 'relation_list.php', 'hero.inc.php');
...
$require_files[EFFECTWONDER_DETAIL]         = array('formula_parser.inc.php', 'wonder.rules.php', 'effectWonderDetail.html.php', 'wonder.inc.php', 'hero.inc.php');
