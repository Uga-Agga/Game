...
$require_files[DEFENSE_BUILDER]             = array('formula_parser.inc.php', 'defense.html.php');
$require_files[DEFENSE_DETAIL]              = array('formula_parser.inc.php', 'defense.html.php');
...
$require_files[HERO_DETAIL]                 = array('formula_parser.inc.php', 'hero.html.php');
...
$require_files[UNIT_DETAIL]                 = array('formula_parser.inc.php', 'unit_properties.html.php', 'unitbuild.inc.php');
$require_files[UNIT_MOVEMENT]               = array('formula_parser.inc.php', 'unitMovement.html.php', 'unitMovement.inc.php', 'artefact.inc.php', 'digest.inc.php', 'movement.lib.php', 'tribes.inc.php', 'relation_list.php', 'hero.html.php');
