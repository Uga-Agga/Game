...
$require_files[CAVE_DETAIL]                 = array('cave.html.php', 'tribes.inc.php', 'relation_list.php', 'hero.inc.php');
...
$require_files[EFFECTWONDER_DETAIL]         = array('wonder.rules.php', 'effectWonderDetail.html.php', 'wonder.inc.php', 'hero.inc.php');
$require_files[EVENT_REPORTS]               = array('../modules/EventReports/EventReports.php');
$require_files[HERO_DETAIL]                 = array('hero.html.php', 'hero.inc.php');
...
$require_files[MAP]                         = array('map.inc.php', 'map.html.php');
$require_files[MAP_REGION]                  = array('map.inc.php', 'map.html.php');
...
$require_files[TRIBE]                       = array('tribe.html.php', 'tribes.inc.php', 'auth.inc.php', 'message.inc.php', 'government.rules.php', 'relation_list.php');
$require_files[TRIBE_ADMIN]                 = array('tribeAdmin.html.php', 'tribes.inc.php', 'auth.inc.php', 'message.inc.php', 'relation_list.php', 'government.rules.php', 'wonder.rules.php');
$require_files[TRIBE_DELETE]                = array('tribeDelete.html.php', 'tribes.inc.php', 'auth.inc.php', 'relation_list.php', 'message.inc.php');
...
$require_files[UNIT_MOVEMENT]               = array('unitMovement.html.php', 'unitMovement.inc.php', 'artefact.inc.php', 'digest.inc.php', 'movement.lib.php', 'tribes.inc.php', 'relation_list.php', 'hero.inc.php');
...
$require_files[WONDER]                      = array('wonder.rules.php', 'wonder.html.php', 'wonder.inc.php', 'message.inc.php');
$require_files[WONDER_DETAIL]               = array('wonder.rules.php', 'wonderDetail.html.php', 'wonder.inc.php');
