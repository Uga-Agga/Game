...
$require_files[UNIT_MOVEMENT]               = array('formula_parser.inc.php', 'unitMovement.html.php', 'unitMovement.inc.php', 'artefact.inc.php', 'digest.inc.php', 'movement.lib.php', 'tribes.inc.php', 'relation_list.php');
