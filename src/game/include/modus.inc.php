...
$require_files[EFFECTWONDER_DETAIL]         = array('rules/wonder.rules.php', 'effectWonderDetail.html.php', 'wonder.inc.php', 'hero.inc.php');
...
$require_files[UNIT_MOVEMENT]               = array('unitMovement.html.php', 'unitMovement.inc.php', 'artefact.inc.php', 'digest.inc.php', 'movement.lib.php', 'tribes.inc.php', 'rules/relation.list.php', 'hero.inc.php');
...
$require_files[WONDER]                      = array('rules/wonder.rules.php', 'wonder.html.php', 'wonder.inc.php', 'message.inc.php');
$require_files[WONDER_DETAIL]               = array('rules/wonder.rules.php', 'wonderDetail.html.php', 'wonder.inc.php');
$require_files[DYK]                         = array('doYouKnow.html.php');
$require_files[MERCHANT]                    = array('merchant.html.php','rules/trade.rules.php','formula_parser.inc.php');
