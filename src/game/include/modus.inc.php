...
DEFINE('BUG_TRACKER',                 'bug_tracker');
...
$require_files[BUG_TRACKER]                 = array('bugTracker.html.php', 'bugTracker.inc.php');
...
$require_files[MAP_DETAIL]                  = array('map.inc.php', 'map.html.php', 'tribes.inc.php');
